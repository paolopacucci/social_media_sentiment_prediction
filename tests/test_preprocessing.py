...
# Verifica che select_columns mantenga solo le colonne richieste.
...
# Verifica che clean_text rimuova gli spazi esterni dai testi.
...
# Verifica che validate_test sollevi errori se il testo è vuoto o composto solo da spazi.
...
# Verifica che clean_label converta correttamente le label in interi.
...
# Verifica che validate_label_012 sollevi un errore se label non sono nell'insieme {0, 1, 2}
